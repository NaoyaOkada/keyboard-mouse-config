...
def configure(keymap):
    ...
    #keymap_global["O-(255)"] = "28" # 変換キーにはIME ONをOSで割り当て
    ...
    fc.toggle_emacs_keybind_key = None
    ...
    # if fc.use_emacs_ime_mode:
        ...
        #  # keymap.defineWindowKeymap(check_func=is_emacs_ime_mode2)
